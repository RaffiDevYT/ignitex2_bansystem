...
--
-- Table structure for table `ignitex2_bansystem`
--

CREATE TABLE `ignitex2_bansystem` (
  `ID` int(11) NOT NULL,
...
--
-- Indexes for table `ignitex2_bansystem`
--
ALTER TABLE `ignitex2_bansystem`
  ADD KEY `ID` (`ID`);
...
--
-- AUTO_INCREMENT for table `ignitex2_bansystem`
--
ALTER TABLE `ignitex2_bansystem`
